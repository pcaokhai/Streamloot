...
rm -f .tmp-capture.mjs .tmp-filename.mjs .tmp-facebook.mjs .tmp-dash.mjs .tmp-youtube.mjs .tmp-pick.mjs .tmp-tasks.mjs .tmp-formats.mjs .tmp-anchor.mjs .tmp-submitGuard.mjs .tmp-m3u8.mjs
